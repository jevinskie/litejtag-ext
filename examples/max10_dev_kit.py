...
class BenchSoC(SoCCore):
    def __init__(self, with_jtagbone=False, sys_clk_freq=int(200e6)):
        ...
        if with_jtagbone:
            ...
            self.jtag_phy.tdo.eq(hello_tdo)
        ...
        self.jtag_phy.do_finalize()
        phy_sigs = self.jtag_phy._signals_recursive
        phy_sigs.remove(self.jtag_phy.altera_reserved_tdo) # wont pass fitter, output must go to pin
        phy_sigs.remove(self.jtag_phy.tdocore)
