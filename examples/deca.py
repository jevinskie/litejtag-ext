...
class BenchSoC(SoCCore):
    def __init__(self, with_jtagbone=False, with_uartbone=False, with_analyzer=False, sys_clk_freq=int(100e6)):
        ...
        SoCMini.__init__(self, platform, clk_freq=sys_clk_freq,
            ident          = "LiteJTAG Hello on MAX10 DECA",
            ident_version  = True
        )
...
def main():
    parser = argparse.ArgumentParser(description="LiteJTAG Hello on MAX10 DECA")
    ...
    soc     = BenchSoC(with_jtagbone=args.with_jtagbone, with_uartbone=args.with_uartbone, with_analyzer=args.with_analyzer)
